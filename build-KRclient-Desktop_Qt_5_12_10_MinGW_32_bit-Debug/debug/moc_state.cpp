...
QT_MOC_LITERAL(1, 6, 7), // "request"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 6), // "answer"
QT_MOC_LITERAL(4, 22, 10) // "numRequest"

    },
    "state\0request\0\0answer\0numRequest"
};
...
void state::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&state::request)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void state::request(QString _t1)
{
